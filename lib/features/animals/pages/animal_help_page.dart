...
class AnimalHelpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ajuda sobre animais')),
      body: ListView(
        padding: const EdgeInsets.fromLTRB(16, 16, 16, 32),
        children: [
          _intro(context),
          const SizedBox(height: 16),
          _section(context, 'Cadastro do animal', Icons.pets_outlined, [
            _item(
              'Brinco',
          ...
          const SizedBox(height: 16),
          _section(context, 'Status do animal', Icons.flag_outlined, [
            _item('Ativo', 'Animal que atualmente faz parte do rebanho.'),
            _item(
              'Vendido',
          ...
          const SizedBox(height: 16),
          _section(context, 'Rebanho e histórico', Icons.groups_outlined, [
            _item(
              'Rebanho atual',
